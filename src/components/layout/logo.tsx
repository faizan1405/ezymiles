...
export function Logo({
  ...
  if (logoUrl) {
    ...
    return <img src={logoUrl} alt={name} className={cn("h-12 w-auto md:h-16 lg:h-20", className)} />;
  }
  ...
  return (
    <span className={cn("flex items-center gap-1", className)}>
      ...
      <span className="flex flex-col leading-none">
        <span
          className="text-xl font-bold tracking-tight md:text-2xl lg:text-[2.25rem]"
