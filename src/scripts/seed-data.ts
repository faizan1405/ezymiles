...
export const destinationSeeds = [
  ...
  },
  {
    ...
    summary: "Mountain drives, paragliding in Bir Billing, and hill-station towns that haven't been over-promoted yet.",
    description: "Himachal's circuits are doable year-round, with the Spiti and Lahaul loops opening only in summer. We build most trips around two or three base towns rather than racing across the state, since the roads don't reward that.",
    heroImage: { url: "https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=1600&q=80", alt: "Himachal Pradesh mountains" },
    gallery: [],
    startingPriceINR: 18000,
    recommendedDurationDays: 6,
    bestMonths: ["Mar", "Apr", "May", "Jun", "Sep", "Oct"],
    currencyUsed: "Indian Rupee (INR)",
    languages: ["Hindi", "English"],
    timezone: "GMT+5:30",
    visaNote: "No visa required for Indian citizens.",
    coordinates: { lat: 31.1048, lng: 77.1734 },
    highlights: [
      "Manali–Solang–Kasol circuit",
      "Paragliding in Bir Billing",
      "Spiti Valley summer loop",
      "Old Manali cafes and riverside camping",
    ],
    faqs: [],
    isFeatured: false,
    isTrending: true,
  ...
  },
  {
    ...
    summary: "Houseboats on Dal Lake, Gulmarg's gondola, and snow views outside Srinagar.",
    description: "Kashmir is best between April and October. Houseboat stays, a Gulmarg day for the gondola and a Pahalgam valley drive cover the highlights without rushing.",
    heroImage: { url: "https://images.unsplash.com/photo-1566837945700-30057527ade0?w=1600&q=80", alt: "Kashmir valley" },
    gallery: [],
    ...
    highlights: ["Dal Lake houseboat stay", "Gulmarg gondola ride", "Pahalgam valley drive", "Mughal gardens in Srinagar"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    summary: "Mountain views, riverside camping, and quiet cafes in Old Manali.",
    description: "Manali works as a base for both relaxed trips and adventure — Solang for the cable car and skiing (in winter), Kasol for quieter cafes, and the Atal Tunnel opening up the Spiti side.",
    heroImage: { url: "https://images.unsplash.com/photo-1605649461784-edc01e8a2c69?w=1600&q=80", alt: "Manali mountains" },
    gallery: [],
    startingPriceINR: 14000,
    recommendedDurationDays: 5,
    ...
    highlights: ["Solang Valley cable car", "Old Manali cafes", "Hadimba Temple", "River-side camping"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    type: "region" as const,
    scope: "domestic" as const,
    themes: ["beach", "weekend", "family"],
    summary: "Beaches, sunset shacks, and a quieter south than the brochure suggests.",
    description: "Goa splits into two halves — north is louder and more social, south is quieter and better for couples. The best trips combine both, with a couple of heritage-site stops in between.",
    heroImage: { url: "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?w=1600&q=80", alt: "Goa beach" },
    gallery: [],
    ...
    highlights: ["North Goa beach day", "South Goa quiet beaches", "Old Goa churches", "Spice plantation visit"],
    faqs: [],
    isFeatured: true,
    isTrending: true,
    status: "published" as const,
  },
  {
    ...
    type: "region" as const,
    scope: "domestic" as const,
    themes: ["family", "luxury", "honeymoon"],
    summary: "Forts, palaces, and a desert that doesn't feel like a tourist-trap camel ride.",
    description: "Rajasthan rewards slow travel — Jaipur, Jodhpur, Udaipur and Jaisalmer each deserve two nights, not a one-day stop. The desert camp outside Jaisalmer is the highlight when it's done well.",
    heroImage: { url: "https://images.unsplash.com/photo-1599661046289-e31897846e41?w=1600&q=80", alt: "Rajasthan fort" },
    gallery: [],
    ...
    highlights: ["Amber Fort in Jaipur", "Mehrangarh Fort in Jodhpur", "Lake Pichola in Udaipur", "Desert camp in Jaisalmer"],
    faqs: [],
    isFeatured: true,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    summary: "Coral reefs, white sand, and ferries that are doable without a private boat.",
    description: "The Andamans pair nicely with a five-to-seven-day trip — Port Blair for history, Havelock for the better beaches and a fixed scuba session, and Neil Island for the quieter evenings.",
    heroImage: { url: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?w=1600&q=80", alt: "Andaman beach" },
    gallery: [],
    ...
    languages: ["Hindi", "English"],
    timezone: "GMT+5:30",
    visaNote: "No visa required for Indian citizens; some islands require special permits.",
    coordinates: { lat: 11.7401, lng: 92.6586 },
    highlights: ["Radhanagar Beach", "Scuba at Havelock", "Cellular Jail history", "Neil Island sunset"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    scope: "international" as const,
    themes: ["beach", "honeymoon", "family"],
    summary: "Bangkok temples, Chiang Mai's old city, and Phuket's calmer northern beaches.",
    description: "Thailand's three main regions — Bangkok, the north (Chiang Mai/Chiang Rai), and the south (Phuket/Krabi) — combine well into a week-long trip with one short domestic flight.",
    heroImage: { url: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=1600&q=80", alt: "Thailand beach" },
    gallery: [],
    startingPriceINR: 35000,
    recommendedDurationDays: 7,
    bestMonths: ["Nov", "Dec", "Jan", "Feb"],
    ...
    timezone: "GMT+7",
    visaNote: "Visa-free entry for Indian passport holders for stays up to 60 days.",
    coordinates: { lat: 13.7563, lng: 100.5018 },
    highlights: ["Bangkok Grand Palace", "Chiang Mai elephant sanctuary", "Phi Phi Islands day trip", "Thai cooking class"],
    faqs: [],
    isFeatured: true,
    isTrending: true,
    status: "published" as const,
  },
  {
    ...
    summary: "A four-day city that mixes hawker food, Sentosa beaches and one of the best airports in the world.",
    description: "Singapore works as a long weekend or a stopover add-on. The zoo, Gardens by the Bay, and Sentosa cover the must-dos; the rest is food, malls and walking.",
    heroImage: { url: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=1600&q=80", alt: "Singapore skyline" },
    gallery: [],
    startingPriceINR: 60000,
    recommendedDurationDays: 4,
    bestMonths: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep"],
    currencyUsed: "Singapore Dollar (SGD)",
    languages: ["English", "Mandarin", "Malay", "Tamil"],
    timezone: "GMT+8",
    visaNote: "Visa-free entry for Indian passport holders.",
    coordinates: { lat: 1.3521, lng: 103.8198 },
    highlights: ["Gardens by the Bay", "Sentosa Island", "Singapore Zoo", "Hawker centre food tour"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    summary: "Kuala Lumpur's skyline, Penang's food, and Langkawi's quieter beaches.",
    description: "Malaysia works as a two-stop trip — KL for the city and food, then Langkawi or Penang for the beach. Both are easy domestic flights from the capital.",
    heroImage: { url: "https://images.unsplash.com/photo-1596428866774-91433f58d4b6?w=1600&q=80", alt: "Malaysia skyline" },
    gallery: [],
    startingPriceINR: 40000,
    recommendedDurationDays: 6,
    bestMonths: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
    ...
    highlights: ["Petronas Towers", "Penang street food", "Langkawi cable car", "Batu Caves"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    summary: "Overwater villas, house reefs, and the easiest luxury beach trip from India.",
    description: "The Maldives is one of the few places where every resort is on its own island. Choose between the atolls for house-reef quality and direct-transfer speed from Malé.",
    heroImage: { url: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=1600&q=80", alt: "Maldives overwater villa" },
    gallery: [],
    startingPriceINR: 90000,
    recommendedDurationDays: 5,
    bestMonths: ["Nov", "Dec", "Jan", "Feb", "Mar", "Apr"],
    currencyUsed: "Maldivian Rufiyaa (MVR) / USD (resorts)",
    languages: ["Dhivehi", "English (resorts)"],
    timezone: "GMT+5",
    visaNote: "Free visa on arrival for Indian passport holders for 30 days.",
    coordinates: { lat: 3.2028, lng: 73.2207 },
    highlights: ["Overwater villa stay", "House reef snorkelling", "Sunset dolphin cruise", "Private sandbank lunch"],
    faqs: [],
    isFeatured: true,
    isTrending: true,
    status: "published" as const,
  },
  {
    ...
    type: "country" as const,
    scope: "international" as const,
    themes: ["family", "weekend", "beach"],
    summary: "Hanoi's old quarter, Halong Bay's limestone cliffs, and Hoi An's lanterns at night.",
    description: "Vietnam rewards a north-to-south loop with one short domestic flight. Halong Bay for the boat, Hoi An for the food and tailoring, and Ho Chi Minh City for the closing nights.",
    heroImage: { url: "https://images.unsplash.com/photo-1528127269322-539801943592?w=1600&q=80", alt: "Vietnam landscape" },
    gallery: [],
    ...
    timezone: "GMT+7",
    visaNote: "e-Visa available for Indian passport holders; usually processed within 3 days.",
    coordinates: { lat: 14.0583, lng: 108.2772 },
    highlights: ["Halong Bay cruise", "Hoi An old town", "Hanoi street food", "Mekong Delta day trip"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    summary: "Cappadocia's balloons, Istanbul's two continents, and a Mediterranean coast worth slowing down in.",
    description: "Turkey usually means Istanbul and Cappadocia, and both earn the hype. We build most itineraries with two or three days in each city plus Aegean coast nights when time allows.",
    heroImage: { url: "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=1600&q=80", alt: "Hot-air balloons over Cappadocia" },
    gallery: [],
    ...
    languages: ["Turkish"],
    timezone: "GMT+3",
    visaNote: "e-Visa available online for Indian passport holders.",
    coordinates: { lat: 41.0082, lng: 28.9784 },
    highlights: ["Cappadocia balloon ride", "Hagia Sophia and Blue Mosque", "Bosphorus boat cruise", "Pamukkale terraces"],
    faqs: [],
    isFeatured: false,
    isTrending: true,
    status: "published" as const,
  },
  {
    ...
    summary: "Beaches, hill-country tea estates, and ancient rock fortresses in a short-haul trip.",
    description: "Sri Lanka packs beaches, hill-country tea estates, ancient rock fortresses and leopard-sighting safaris into a trip shorter than most people expect.",
    heroImage: { url: "https://images.unsplash.com/photo-1586183189334-1596e7ec6f30?w=1600&q=80", alt: "Sigiriya rock fortress" },
    gallery: [],
    ...
    timezone: "GMT+5:30",
    visaNote: "ETA required for Indian passport holders.",
    coordinates: { lat: 7.8731, lng: 80.7718 },
    highlights: ["Sigiriya rock fortress", "Yala leopard safari", "Nuwara Eliya tea estates", "South-coast beaches"],
    faqs: [],
    isFeatured: true,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    scope: "international" as const,
    themes: ["honeymoon", "luxury", "beach"],
    summary: "Lagoon-calm beaches and inland adventures beyond the resort brochures.",
    description: "Mauritius resorts sell the lagoon and it's genuinely that calm. A day inland — Chamarel's coloured earth, a rum distillery tour — makes the trip more than poolside.",
    heroImage: { url: "https://images.unsplash.com/photo-1544644181-1484b3fdfc62?w=1600&q=80", alt: "Turquoise lagoon in Mauritius" },
    gallery: [],
    ...
    highlights: ["West-coast lagoon", "Chamarel coloured earth", "Île aux Cerfs day trip", "Casela Nature Park"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    summary: "Tokyo's pace, Osaka's food, and a rail network that makes multi-city trips easy.",
    description: "First-timers usually do Tokyo, Kyoto and Osaka across a week. The Shinkansen makes three cities genuinely manageable, which is why so many travellers return.",
    heroImage: { url: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=1600&q=80", alt: "Mount Fuji beyond a torii gate" },
    gallery: [],
    ...
    highlights: ["Tokyo neighbourhood walking", "Kyoto temple mornings", "Osaka street food", "Mount Fuji viewpoint"],
    faqs: [],
    isFeatured: false,
    isTrending: true,
    status: "published" as const,
  },
  {
    ...
    summary: "Multi-country trips — Italy, France, Switzerland and beyond, planned as one itinerary.",
    description: "Most multi-country trips we plan cover two or three countries: Paris and the French countryside, Swiss Alps, Italy's cities, or a Balkans route.",
    heroImage: { url: "https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=1600&q=80", alt: "European old-town square" },
    gallery: [],
    ...
    visaNote: "Schengen visa covers most mainland-Europe itineraries.",
    coordinates: { lat: 48.8566, lng: 2.3522 },
    highlights: ["Multi-country routing", "Rail pass connections", "Schengen visa assistance", "City + countryside split"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    scope: "international" as const,
    themes: ["honeymoon", "luxury", "beach"],
    summary: "Granite boulders on powder beaches — the Indian Ocean at its most photogenic.",
    description: "Seychelles is ideal for a honeymoon or luxury long weekend. La Digue's Anse Source d'Argent is one of the most photographed beaches on earth for a reason.",
    heroImage: { url: "https://images.unsplash.com/photo-1587133227058-7dec7b10a6d5?w=1600&q=80", alt: "Granite boulders on a Seychelles beach" },
    gallery: [],
    startingPriceINR: 140000,
    recommendedDurationDays: 5,
    bestMonths: ["Apr", "May", "Jun", "Sep", "Oct", "Nov"],
    currencyUsed: "Seychellois Rupee (SCR)",
    languages: ["English", "French", "Seychellois Creole"],
    timezone: "GMT+4",
    visaNote: "Visa-free entry for Indian passport holders for stays up to 90 days.",
    coordinates: { lat: -4.6796, lng: 55.4920 },
    highlights: ["Anse Source d'Argent beach", "Vallee de Mai UNESCO site", "Island hopping to Praslin", "Snorkelling at Sainte Anne"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    themes: ["honeymoon", "luxury", "beach"],
    summary: "Lagoon-calm beaches and inland adventures beyond the resort brochures.",
    description: "Mauritius resorts sell the lagoon and it's genuinely that calm. A day inland — Chamarel's coloured earth, a rum distillery — makes the trip more than poolside.",
    heroImage: { url: "https://images.unsplash.com/photo-1544644181-1484b3fdfc62?w=1600&q=80", alt: "Turquoise lagoon beach in Mauritius" },
    gallery: [],
    startingPriceINR: 110000,
    recommendedDurationDays: 6,
    bestMonths: ["May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov"],
    ...
    visaNote: "Visa-free entry for Indian passport holders for stays up to 90 days.",
    coordinates: { lat: -20.3484, lng: 57.5522 },
    highlights: ["West-coast lagoons", "Chamarel seven-coloured earth", "Rum distillery tour", "Île aux Cerfs boat trip"],
    faqs: [],
    isFeatured: false,
    isTrending: false,
    status: "published" as const,
  },
  {
    ...
    scope: "international" as const,
    themes: ["family", "wildlife", "beach", "weekend"],
    summary: "Beaches, tea estates and ancient rock fortresses in a short-haul trip.",
    description: "Sri Lanka packs beaches, hill-country tea estates, ancient rock fortresses and leopard-sighting safaris into a trip shorter than most people expect.",
    heroImage: { url: "https://images.unsplash.com/photo-1586183189334-1596e7ec6f30?w=1600&q=80", alt: "Sigiriya rock fortress rising above the jungle" },
    gallery: [],
    startingPriceINR: 45000,
    recommendedDurationDays: 6,
    bestMonths: ["Dec", "Jan", "Feb", "Mar"],
